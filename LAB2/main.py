...
Original file is located at
    https://colab.research.google.com/drive/16hnUz0jdLJp24FpVk7KixoKPue_hlA_W
...
with open(file_path, 'r') as file:
    ...
    # Example of finding a specific line
    for line in lines:
        if "List to Tuple:" in line:
            print("Found line:", line.strip())


with open(file_path, 'a') as file:
    file.write("\nNew data: This line was added later.")


with open(file_path, 'r') as file:
    lines = file.readlines()
    print(lines[-1])  # Printing the last line to verify the addition
